...
describe(`tests/cancelling-subscription-paid-immediate-refund`, () => {
  it('should work via UI browsing', async () => {
    ...
    await TestHelperBrowser.waitForWebhook('customer.subscription.created', () => {
      return true
    })
    await TestHelperBrowser.waitForWebhook('charge.succeeded', () => {
      return true
    })
